    ...
    function initApi(callback) {
      if (apiInited) {
        ...
        if (!apiInitStarted) {
          ...
          var firstRlottieWorker = rlottieWorkers[0] = new QueryableWorker('./js/tgsticker-worker.js?11');
          firstRlottieWorker.addListener('ready', function () {
            ...
            if (!workersRemain) {
              ...
              for (var workerNum = 1; workerNum < rlottie.WORKERS_LIMIT; workerNum++) {
                (function(workerNum) {
                  var rlottieWorker = rlottieWorkers[workerNum] = new QueryableWorker('./js/tgsticker-worker.js?11');
